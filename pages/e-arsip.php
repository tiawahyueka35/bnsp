        ...
        ?>
            <tr>
                ...
                <td>
                    ...
                    <button type="button" class="btn btn-warning btn-sm"><a target="_blank" href="http://localhost/bnsp/arsip/<?php echo $file?>" class="tombol" style="color:white">Unduh</a></div>
